...
if os.path.exists("results_histograms.pdf"):
    os.remove("results_histograms.pdf")
else:
    print('PDF_hist File does not exists')
    
if os.path.exists("results_SIM.xlsx"):
    os.remove("results_SIM.xlsx")
else:
    print('excel File does not exists')

# Say where to save the file and with what name (note the use of / instead of \)
xlsx_path = "C:/Users/esn001/Desktop/python/SIM real/results_SIM.xlsx"
...
pdf1_filename = "results_figures.pdf"
...
Histograms.savefig('results_histograms.pdf')
